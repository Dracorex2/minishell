...
/*   Updated: 2025/05/14 16:30:18 by lucmansa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int execute_builtins(char *cmd, t_minishell *minishell, int nb_cmd)
{
	...
	if (ft_strcmp(cmd, "cd") == 0)
		return(ft_cd(args, minishell->env), 1);
	//else if (ft_strcmp(cmd, "pwd") == 0)
	//	return(ft_pwd(), 1);
	//else if (ft_strcmp(cmd, "export") == 0)
	//	return(ft_export(args, minishell->env), 1);
	//else if (ft_strcmp(cmd, "unset") == 0)
	//	return(ft_unset(args, minishell->env), 1);
	//else if (ft_strcmp(cmd, "env") == 0)
	//	return(ft_env(args, minishell->env), 1);
